...
def get_opex_estimate(annual_heat_kwh_consumption: float, scops: list[float]) -> list[OpexEstimate]:
    return [
        OpexEstimate(
            annual_heat_pump_elec_cost=123.45,
            annual_gas_boiler_counterfactual_cost=234.56,
            annual_carbon_kg_reduction=12.3,
        )
    ]
